...
**實際每日條數（2026-09-09 實測，唔係估算）**：門檻 10000 → **每日約 147 條**，
即係差唔多每 10 分鐘一條。香港門檻 500 → 每日約 55 條。

⚠️ 唔好用「6 小時窗入面未完結嘅條數」去推算每日量——嗰個係**存量**（當下仲熱
緊幾多條），推送累積嘅係**流量**（成日總共有幾多條升穿門檻）。同一次量度：
24 小時窗 ≥10000 未完結得 27 條，但總數係 83 條，而實際推送量仲高過 83，
因為 24 小時窗只係一個切面。要估每日量，睇「總數」嗰欄，唔好睇「未完結」。

想調：20000 大約砍一半，50000 大約每日十幾條，5000 就會變成每幾分鐘一條。
